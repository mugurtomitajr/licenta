...
Scene02::~Scene02() { this -> _clear(); }

void Scene02::Start() {
    Scene::Start();
}

void Scene02::Update(double dt, const glm::vec2 &p_deltaMouse, bool *p_keyPressedArray) {
...
void Scene02::_loadModels() {
    Scene::_loadModels();
}

void Scene02::_loadInstances() {
...
void Scene02::_loadCamera(GLfloat p_verticalFov, GLfloat p_displayRatio) {
